...
<head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5176242658603485"
            crossorigin="anonymous"></script>
    <title>Movie App</title>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
    <style type="text/css">
        .adBlock { width: 300px; height: 100px; }
            ...
            <div class="mt-3 md:mt-0 md:ml-4">
                <a href="#">
                    <img class="rounded-full w-8 h-8"
                         src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80"
                         alt=""/>
                </a>
            </div>
        </div>
...
<div class="py-10">
    ...
    <ins class="adsbygoogle adBlock"
         ...
         data-ad-client="ca-pub-5176242658603485"
         data-ad-slot="7826842646"
...
<footer class="border border-t border-gray-800">
    <div class="container mx-auto text-sm px-4 py-6">
        <h2>Powered by
            <a href="https://www.themoviedb.org/documentation/api" class="underline hover:text-gray-300">TMDb
                API
            </a>
        </h2>
    </div>
