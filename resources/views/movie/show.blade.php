...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                        @foreach($movie['crew'] as $crew)
                            <div>
                                <div class="mr-8">{{ $crew['name'] }}</div>
                                <div class="text-sm text-gray-400 mr-1">{{ $crew['job'] }}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
                        ...
                        <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                            <div class="bg-gray-900 rounded">
                                <div class="flex justify-end pr-4 pt-2">
                                    <button
                                        @click="isOpen = false"
                                        class="text-3xl leading-none hover:text-gray-200">&times;
                                    </button>
                                </div>
    ...
    <div class="movie-screenshot" x-data="{isOpen: false, image:''}">
        <div class="container mx-auto px-4 py-16">
