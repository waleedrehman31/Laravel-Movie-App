        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    <svg class="fill-current text-gray-400 hover:text-white w-4 mt-2" viewBox="0 0 448 512">
                        <path
                    ...
                    <span
                        class="ml-2 mt-2">{{ $actor['birthday'] }} ({{ $actor['age'] }} year old) in {{ $actor['place_of_birth'] }}</span>
                </div>
                    ...
                    @foreach($knownForMovies as $movie)
                        <div class="mt-4">
                            <a href="{{ $movie['linkToPage'] }}">
                                <img src="{{ $movie['poster_path'] }}" alt="imageOfMovie"
